...
import ImageSwapper from '../components/ImageSwapper'; // Correct the import here
...
const Dashboard = () => {
    ...
    // Define your images array (either import them or use paths from a folder)
    const images = [
        ...
        <div>
            {isAuthorized ? (
                <div className='pl-[10vw] space-y-10 p-3 mt-[5vh] overflow-hidden'>
                    ...
                    <div className='pt-5 space-y-5 text-4xl font-bold'>Let's see what great plans you have!</div>
